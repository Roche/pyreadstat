...
object contains the following fields:
  ...
  * missing_user_values: a list of character values (A to Z) representing user defined missing values in SAS and STATA.
    This appears when using user_missing=True in read_sas7bdat (not enabled for other file types at the moment). It does
    not always work: it seems that files written in windows are fine, while files written on unix throw errors, even if
    they do not have user defined missing values.
